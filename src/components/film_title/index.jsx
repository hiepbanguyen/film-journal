...
const FilmTitle = () => {
  ...
  const casts = [
    ...
    'Andrew Arrabito', 'Johnny Alexander', 'Show All…'
  ]
  const Populer_reviews = [
    ...
    },
    {
      id: 3,
      name: "the film drunk",
      image: "https://a.ltrbxd.com/resized/avatar/twitter/1/2/7/3/1/1/1/shard/http___pbs.twimg.com_profile_images_1571602042879365120_ghpMDAQT-0-80-0-80-crop.jpg?v=f62659ab1b",
      rating: 4,
  ...
  const recent_reviews = [
    ...
    },
    {
      ...
      rating: 3.5,
      comment: "amazing visuals, cool word building and really feels like your there on the planet. story was a bit basic but saved by interesting visuals and overall spectacle",
    },
    {
      id: 3,
      name: "hughenden",
      ...
      rating: 5,
      comment: "My favorite film of 2022 I loved every second of it the cgi is gorgeous but a Dora is more beautiful than ever so many great characters I never really like kids in movies but these ones stole the show or me amazing can’t wait for the 3 one",
    }
  ]
  const related_films = [
    {
      id: 1,
      image: "https://a.ltrbxd.com/resized/sm/upload/1p/mh/li/l2/b7nR3eKeTOwHPKmDLUWunIGasKo-0-230-0-345-crop.jpg?v=0bb5ec98ec",
  ...
  const similar_films = [
    {
      id: 1,
      image: "https://a.ltrbxd.com/resized/sm/upload/t1/n6/d1/k6/g2mqdMU3jaz6uEosF5aqJgbw7e9-0-230-0-345-crop.jpg?v=f105fa4be0",
      url: "https://letterboxd.com/film/star-wars-the-force-awakens/"
    },
    {
      id: 2,
      image: "https://a.ltrbxd.com/resized/sm/upload/wx/hm/hf/14/uKnhbfNt1ZR2TdoZpdn7vSNZlhX-0-230-0-345-crop.jpg?v=3bdae194cc",
      url: "https://letterboxd.com/film/man-of-steel/"
    },
    {
      id: 3,
      image: "https://a.ltrbxd.com/resized/sm/upload/8x/qv/nm/63/ijQHiImv16vNSeZQsmih04kwn0C-0-230-0-345-crop.jpg?v=fa3e7ba9ed",
      url: "https://letterboxd.com/film/war-for-the-planet-of-the-apes/"
    },
    {
      id: 4,
      image: "https://a.ltrbxd.com/resized/film-poster/3/0/9/1/0/7/309107-godzilla-king-of-the-monsters-0-230-0-345-crop.jpg?v=d6625b756a",
      url: "https://letterboxd.com/film/godzilla-king-of-the-monsters-2019/"
    },
    {
      id: 5,
      image: "https://a.ltrbxd.com/resized/sm/upload/nx/8b/vs/gc/cDbNAY0KM84cxXhmj8f0dLWza3t-0-230-0-345-crop.jpg?v=49eed12751",
  ...
  const Populer_list = [
    {
      ...
      user_image : "https://a.ltrbxd.com/resized/avatar/twitter/1/6/3/7/4/8/4/shard/http___pbs.twimg.com_profile_images_825988154196840450_kcksfwve-0-32-0-32-crop.jpg?v=2abcc7bbc7",
      user_name : "Emma Tolkin",
      user_link: "https://letterboxd.com/etolkin/",
      total_film : 707,
      likes : 43000,
      comments: 429,
      description: "Asked Twitter “What’s the most visually insane movie you’ve ever seen?” Adding your answers! Am I missing your favorite hallucinogenic,…"
    },
    {
      id: 2,
      ...
      likes : 16000,
      comments: 180,
      description: "All nominated films across all key categories for the 95th annual Academy Awards 2023. The Oscars will be held on…"
    },
    {
      id: 3,
    ...
    <div className="root" style={{ backgroundColor: '#14181c' }}>
      ...
      <div id="content">
        <div className="content_left">
          ...
          <p style={{display: 'flex', justifyContent : 'center', alignItems: 'center', fontSize: '13px', width: 230, margin: '16px 0 30px 0'}}> 
            <RemoveRedEyeRoundedIcon style={{fontSize: "18px",  color: "#00c030"}}></RemoveRedEyeRoundedIcon> {film_detail.views/1000}K &nbsp; 
            <GridViewSharpIcon style={{fontSize: "18px", color: "#40bcf4"}} ></GridViewSharpIcon>{film_detail.appear/1000}K &nbsp;
            <FavoriteIcon style={{fontSize: "18px", color: "#ff9010"}}></FavoriteIcon>{film_detail.likes/1000}K
          </p>
          <div className="watch_panel">
              ...
              <div className="services">
                ...
                <a className="services_title" href="https://www.amazon.com/dp/B002VPE1B6?tag=letterboxd-20&linkCode=osi&th=1&psc=1&language=en_US">Amazon US</a>
                <a className="services_option" href="https://www.amazon.com/dp/B002VPE1B6?tag=letterboxd-20&linkCode=osi&th=1&psc=1&language=en_US">DISC</a>
              </div>
              <div className="other_message">
                <a href="https://letterboxd.com/pro/">Go <span className="pro">PRO</span> to customize this list</a>
              </div>
              <div className="all_services">
                <a className="all" href="https://letterboxd.com/film/avatar-the-way-of-water/watch/">All services...</a>
                <a className="justwatch" href="https://www.justwatch.com/">JustWatch</a>
              </div>
          </div>
        </div>
        <div className="content_right">
          ...
          <div className="content_right_description">
            ...
            <div style={{ flex: 1 }} className="description_review">
              <div>
                <div className="box_share" style={{ borderBottom: "1px solid #2c3440", borderRadius: "5px 5px 0 0" }}>Sign in to log, rate or review</div>
                <div className="box_share" style={{ borderRadius: "0 0 5px 5px" }}>Share</div>
              </div>
          ...
          <div style={{ margin: '30px 0' }}>
            <p className="text-link text-footer">
              192&nbsp;mins &nbsp;
              More at
              <a href="" className="micro_button">IMDb</a>
              <a href="" className="micro_button">TMDb</a>
            </p>
          </div>
          <div className="cart_summary">
            <img src="https://a.ltrbxd.com/resized/sm/upload/t9/q5/dj/9a/Journal%20header%205-620-620-348-348-crop-fill.jpg?k=ecccb7d256" alt="" />
            <div className="cart_summary_title">
              <p>NEWS The Letterboxd crew rounds up our favorite first-time watches of 2022.<b> READ POST</b></p>
            </div>
          </div>
                ...
                <div key={review_item.id} className={calculate_last_item(review_item.id, "review_item")}>
                  ...
                  <div className="title_review">
                    <p className="attribution">
                      Review by <b>{review_item.name}</b> <span className="rating_green rated-7"> {calculate_rating(review_item.rating)}</span> <ChatBubbleIcon fontSize="13px" style={{ lineHeight: '19.5px' }}></ChatBubbleIcon> {review_item.number_comment_reply}
                    </p>
                    <p className="comment">
                      {review_item.comment}
                    </p>
                    <p className="like_link">
                      <FavoriteIcon fontSize="19px"></FavoriteIcon>{review_item.likes} likes
                    </p>
                  </div>
                </div>
              ))
            ...
            </div>
            {
              recent_reviews.map((review_item, i) => (
                <div key={review_item.id} className={calculate_last_item(review_item.id, "review_item")}>
                  ...
                  <div className="title_review">
                    <p className="attribution">
                      Review by <b>{review_item.name}</b> <span className="rating_green rated-7"> {calculate_rating(review_item.rating)}</span>
                    </p>
                    <p className="comment">
                      {review_item.comment}
                    </p>
            ...
            <div className="story">
              {
                mentioned_by.map((mentioned_item) => (
                  <div key={mentioned_item.id} className="story_item">
                    ...
                    <StorageRoundedIcon style={{backgroundColor: '#4c60dc', position: 'absolute', zIndex: 1, top: 0, right: 0, borderRadius: 12, fontSize: 22}}></StorageRoundedIcon>
                  </div>
                ))
              }
            </div>
                  ...
                  Populer_list.map((populer_list_item) => (
                    <div key={populer_list_item.id} className={calculate_last_item(populer_list_item.id, "populer_list_item")}>
                      ...
                      <div className="populer_list_content">
                        <p style={{color: "#fff"}}><b>{populer_list_item.title}</b></p>
                        <p style={{margin: '5px 0', fontSize: 14, display: "flex", alignItems: "center"}}>
                          <img className="img_user" src={populer_list_item.user_image} alt="" /> &nbsp; <b>{populer_list_item.user_name}</b> &nbsp;  {populer_list_item.total_film} films &nbsp; <span><FavoriteIcon fontSize="19px"></FavoriteIcon>{populer_list_item.likes/1000}K</span> &nbsp;  <span><ChatBubbleIcon fontSize="13px" style={{ lineHeight: '19.5px' }}></ChatBubbleIcon>{populer_list_item.comments}</span>
                        </p>
