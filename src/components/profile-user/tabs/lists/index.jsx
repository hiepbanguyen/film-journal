    ...
    <>
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 0" }}>
        ...
        >
          ...
          <FilmCardsStackedFive></FilmCardsStackedFive>
        </Box>
        <Box sx={{ width: 1, padding: "0 20px" }}>
          ...
          <Box sx={{ marginBottom: "8px", display: "flex", alignItems: "center", fontSize: "14px" }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", marginRight: "16px" }}>
              <FavoriteIcon sx={{ marginRight: "4px", fontSize: "16px" }}></FavoriteIcon> {item.totalLike}
            </Box>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <ChatBubbleIcon sx={{ marginRight: "4px", fontSize: "16px" }}></ChatBubbleIcon> {item.totalComment}
            </Box>
          </Box>
